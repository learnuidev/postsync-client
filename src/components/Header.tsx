...
import { Calendar, LogIn, LogOut, Navigation, Settings, Home, Search } from "lucide-react";
...
export default function Header() {
	...
	return (
		<>
			...
			{user && (
				<nav className={`fixed top-20 left-0 right-0 z-40 px-4 ${theme.card} ${theme.border} border-b shadow-sm`}>
